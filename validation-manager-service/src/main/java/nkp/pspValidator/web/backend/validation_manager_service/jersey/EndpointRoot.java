...
public class EndpointRoot {
    ...
    String serviceName = "validation-manager-service";
    String version;
    String build;
    ...
    public Response getHtml() {
        ...
        sb.append("<p>").append("GET ").append("<a href=\"./api/validations\">/api/validations</a>").append("</p>");
        sb.append("<p>").append("GET ").append("<a href=\"./api/validations/runPlanner\">/api/validations/runPlanner</a>").append(" (<i>TODO: remove in production</i>)").append("</p>");
        sb.append("<div>");
